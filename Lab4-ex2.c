//Implementati o functie int* makeRandLimitArray(int seed, unsigned n, int a, int b) care primeste un seed, 
//si numerele naturale n, a si b si returneaza un vector alocat dinamic, 
